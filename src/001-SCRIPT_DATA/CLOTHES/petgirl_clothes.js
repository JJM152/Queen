...
App.Data.Clothes["cow headband"] = { // +9
    ...
    "WearEffect":[ "FEMININE_CLOTHING" ], "Category" : [ "Pet Girl" ]
};
...
App.Data.Clothes["nipple bells"] = { // +9
    ...
    "WearEffect": [ "PERVERTED_CLOTHING" ], "Category" :  [ "Pet Girl", "BDSM" ]
};
...
App.Data.Clothes["cow corset"] = { // +10
    ...
    "WearEffect": [ "FEMININE_CLOTHING", "WAIST_CINCHING" ], "Category" :  [ "Pet Girl" ]
};
...
App.Data.Clothes["cow skirt"] = { // +20
    ...
    "WearEffect": [ "FEMININE_CLOTHING", "FLIRTY" ], "Category" :  [ "Pet Girl", "Bimbo" ]
};
// PANTS SLOT
...
App.Data.Clothes["cow boots"] = { // +20
    ...
    "WearEffect": [ "FEMININE_CLOTHING", "FANCY_MOVES" ], "Category" : [ "Pet Girl", "Sexy Dancer" ]
};
...
App.Data.Clothes["cow tail"] = { // +9
    ...
    "WearEffect": [ "PERVERTED_CLOTHING", "GAPE_TRAINING" ], Category : [ "Pet Girl", "BDSM" ]
};
// PENIS SLOT

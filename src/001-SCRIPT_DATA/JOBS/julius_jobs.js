...
App.Data.JobData["QUAR02"] = {
    ...
    "SCENES" : [
        ...
        },
        {
            ...
            "START" :
                "NPC_NAME says s(Ah, PLAYER_NAME, you're up! @@color:lime;Well, I have good news@@ - it seems that the test results \
                are in and I've been able to re-create an old brew from these notes the Captain found. Thanks for your help... here \
                have some extra coin and if you're interested, @@color:orange;a new drink should be available in my shop@@... it's a \
        ...
        },
        {
            ...
            "START" :
                "NPC_NAME says s(Ah, PLAYER_NAME, you're up! @@color:lime;Well, I have good news@@ - it seems that the test results \
                are in and I've been able to re-create an old brew from these notes the Captain found. Thanks for your help... here \
                have some extra coin and if you're interested, @@color:orange;a new potion should be available in my shop@@... it's \

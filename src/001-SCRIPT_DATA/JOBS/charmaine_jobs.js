...
App.Data.JobData["CHARMAINE_JOB1"] = {
    "ID": "CHARMAINE_JOB1", "TITLE": "Whoring - Handjob Specialist", "GIVER": "Charmaine", "PAY" : 50,
    "RATING" : 3, // of 5
    "PHASES" : [ 2, 3 ],
    "DAYS"   : 1,
    "HIDDEN" : false,
    ...
    "SCENES" : [
        ...
        {   // If pass check 'A' and If counter is at MAX (5), reward player and set counter to 0.
            ...
            "TRIGGERS" :[
                ...
                { "TYPE" : "COUNTER", "NAME" : "CHARMAINE_LOOT", "VALUE" : 5, "CONDITION" : "gte" }
            ],
            "TRIGGERS_ANY" : [ ],
            "CHECKS" : [ ],
            "POST" : [
                { "TYPE" : "NPC_STAT",  "NAME" : "Mood", "VALUE" : 5 },
                { "TYPE" : "FLAG",      "NAME" : "CHARMAINE_LOOT",              "VALUE" :   0,  "OPT" : "SET" },
        ...
        {   // If passed both checks then increment counter. Doesn't trigger if the counter is already at MAX (5) or the reward has been given this time.
            ...
            "TRIGGERS" :[
                ...
                { "TYPE" : "TAG", "NAME" : "B", "VALUE" : 100, "CONDITION" : "gte" },
                { "TYPE" : "TAG", "NAME" : "C", "VALUE" : 100, "CONDITION" : "gte" },
                { "TYPE" : "COUNTER", "NAME" : "CHARMAINE_LOOT", "VALUE" : 4, "CONDITION" : "lte" },
                { "TYPE" : "FLAG", "NAME" : "CHARMAINE_REWARD",  "OPT" : "NOT_SET" }
            ],
            "TRIGGERS_ANY" : [ ],
            "CHECKS" : [ ],
            "POST" : [
        ...
        {  // Check to see if we passed all the events and if the store is not unlocked, then unlock it.
            ...
            "TRIGGERS" :[
                ...
                { "TYPE" : "TAG",  "NAME" : "B", "VALUE" : 100, "CONDITION" : "gte" },
                { "TYPE" : "TAG",  "NAME" : "C", "VALUE" : 100, "CONDITION" : "gte" },
                { "TYPE" : "FLAG", "NAME" : "CHARMAINE_HANDJOB_UNLOCK",  "OPT" : "NOT_SET" }
            ],
            "TRIGGERS_ANY" : [ ],
            "CHECKS" : [ ],
            "POST" : [
        ...
        {   // Just unset the flag that shows we received loot and make sure we clear the counter.
            "ID" : "SCENE04c",
            "TRIGGERS" :[
                { "TYPE" : "FLAG", "NAME" : "CHARMAINE_REWARD", "OPT" : "SET" }
            ],
            "TRIGGERS_ANY" : [ ],
            "CHECKS" : [ ],
            "POST" : [
                { "TYPE" : "FLAG",   "NAME" : "CHARMAINE_REWARD",  "OPT" : "DELETE" }
            ],
            "START" : "",
            "END" : "",
            "RESULTS" : [ ]
...
App.Data.JobData["CHARMAINE_JOB2"] = {
    "ID": "CHARMAINE_JOB2", "TITLE": "Whoring - Blowjob Specialist", "GIVER": "Charmaine", "PAY" : 50,
    "RATING" : 3, // of 5
    "PHASES" : [ 2, 3 ],
    "DAYS"   : 1,
    "HIDDEN" : false,
    ...
    "SCENES" : [
        ...
        {  // Check to see if we passed all the events and if the store is not unlocked, then unlock it.
            ...
            "TRIGGERS" :[
                ...
                { "TYPE" : "TAG",  "NAME" : "B", "VALUE" : 100, "CONDITION" : "gte" },
                { "TYPE" : "TAG",  "NAME" : "C", "VALUE" : 100, "CONDITION" : "gte" },
                { "TYPE" : "FLAG", "NAME" : "CHARMAINE_BLOWJOB_UNLOCK",  "OPT" : "NOT_SET" }
            ],
            "TRIGGERS_ANY" : [ ],
            "CHECKS" : [ ],
            "POST" : [
...
App.Data.JobData["CHARMAINE_JOB3"] = {
    "ID": "CHARMAINE_JOB3", "TITLE": "Whoring - Tit Fucking Specialist", "GIVER": "Charmaine", "PAY" : 50,
    "RATING" : 3, // of 5
    "PHASES" : [ 2, 3 ],
    "DAYS"   : 1,
    "HIDDEN" : false,
    ...
    "SCENES" : [
        ...
        {  // Check to see if we passed all the events and if the store is not unlocked, then unlock it.
            ...
            "TRIGGERS" :[
                ...
                { "TYPE" : "TAG",  "NAME" : "B", "VALUE" : 100, "CONDITION" : "gte" },
                { "TYPE" : "TAG",  "NAME" : "C", "VALUE" : 100, "CONDITION" : "gte" },
                { "TYPE" : "FLAG", "NAME" : "CHARMAINE_TIT_UNLOCK",  "OPT" : "NOT_SET" }
            ],
            "TRIGGERS_ANY" : [ ],
            "CHECKS" : [ ],
            "POST" : [
...
App.Data.JobData["CHARMAINE_JOB4"] = {
    "ID": "CHARMAINE_JOB4", "TITLE": "Whoring - Anal Specialist", "GIVER": "Charmaine", "PAY" : 50,
    "RATING" : 3, // of 5
    "PHASES" : [ 2, 3 ],
    "DAYS"   : 1,
    "HIDDEN" : false,
    ...
    "SCENES" : [
        ...
        {  // Check to see if we passed all the events and if the store is not unlocked, then unlock it.
            ...
            "TRIGGERS" :[
                ...
                { "TYPE" : "TAG",  "NAME" : "B", "VALUE" : 100, "CONDITION" : "gte" },
                { "TYPE" : "TAG",  "NAME" : "C", "VALUE" : 100, "CONDITION" : "gte" },
                { "TYPE" : "FLAG", "NAME" : "CHARMAINE_ASS_UNLOCK",  "OPT" : "NOT_SET" }
            ],
            "TRIGGERS_ANY" : [ ],
            "CHECKS" : [ ],
            "POST" : [

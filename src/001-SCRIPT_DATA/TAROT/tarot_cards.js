...
App.Data.Tarot["001"] = {
    Name: "The Magician",
    Css: "tcard1",
    Chat: "\"Ah... The Magician. Your fate is one of good fortune leading you towards your truest potential. I see you have been held back from that which you seek by someone who has imposed transformation upon you. Your card foretells more positive changes ahead.\""+
...
App.Data.Tarot["002"] = {
    Name: "The Popess",
    Css: "tcard2",
    Chat: "\"It is The Popess who guides your future, I see. You shall venture upon the sea, though your destination remains shrouded by mystery. The Popess shelters you in the divine, her feminine influence restoring life and vitality.\"\n\n"+
...
App.Data.Tarot["003"] = {
    Name: "The Empress",
    Css: "tcard3",
    Chat: "\"Your future falls under the protection of The Empress. She is the steward of life, a nurturer and sustainer. Her blessings herald the creation of good things and more bountiful times ahead.\"\n\n"+
...
App.Data.Tarot["004"] = {
    Name: "The Emperor",
    Css: "tcard4",
    Chat: "\"I see your fate is ruled by The Emperor. His power is unyielding and cold, but his influence is one of masculinity and assertiveness. His command of the world symbolizes the control you seek.\"\n\n"+
...
App.Data.Tarot["005"] = {
    Name: "The Pope",
    Css: "tcard5",
    Chat: "\"It seems the wisdom of the The Pope steers your fortune. He brings the blessings of knowledge to you. However, he also heralds the influence of one who will help you define your role in a group which surrounds you. Whether for better or worse, it is not for me to say.\"\n\n"+
    ...
    Msg: "ust as your consciousness reaches the verge of sleep, the fortune teller's predictions emerge briefly but clearly as your night's final thought. You recall the strange sensation of learning without knowing exactly what you'd learned, and remember the person she said would help you define your role. Very strange.\n\n"+
    "One of your skills has improved.",
...
App.Data.Tarot["006"] = {
    Name: "The Lovers",
    Css: "tcard6",
    Chat: "\"The cards foretell it is The Lovers who sway your future. Their appearance tells of us of a romance which stands at a crossroads. How this dilemma will resolve is uncertain, but temptation and sacrifice are surely involved.\"\n\n"+
...
App.Data.Tarot["007"] = {
    Name: "The Chariot",
    Css: "tcard7",
    Chat: "\"The Chariot leads the way forwards into your future. Energy and determination grow within you to face decisions ahead, but your path must be chosen with care. The Chariot's way is one of divine guidance and victory through hard choices, but only if one proceeds wisely.\"\n\n"+
...
App.Data.Tarot["008"] = {
    Name: "Justice",
    Css: "tcard8",
    Chat: "\"Your fate now rests with the hands of Justice. This path is one of balance and decision, delivering those who pay heed to her into right action and responsibility. Her guidance will help bring clarity and awareness to your situation so you can do what you must.\"\n\n"+
...
App.Data.Tarot["009"] = {
    Name: "The Hermit",
    Css: "tcard9",
    Chat: "\"I see The Hermit is now the herald of your future. He reflects upon the inward knowledge of one's truest self, and leads one towards removing distractions. With his guidance, you may begin to find the new direction you are seeking.\"\n\n"+
...
App.Data.Tarot["010"] = {
    ...
    Css: "tcard10",
    Chat: "\"Ah, this card signals a turning point. The Wheel of Fortune brings forth destiny, offering luck in misfortune and opportunity that springs from accidents. It is said the Wheel can change one's stars, though it is up to you to chart the course that suits you most.\"\n\n"+
...
App.Data.Tarot["011"] = {
    Name: "Strength",
    Css: "tcard11",
    Chat: "\"Your fortune resides in the ascendancy of Strength. Though pure might is one aspect of this card, Strength can also signal composure in the face of danger, calm amid frustration, and the ability to overcome adversaries with compassion and persuasion.\"\n\n"+
...
App.Data.Tarot["012"] = {
    Name: "The Hanged Man",
    Css: "tcard12",
    Chat: "\"Very interesting, indeed,\" says Madame Blanche. \"It appears your fate resides with The Hanged Man.\"\n\n"+
...
App.Data.Tarot["013"] = {
    Name: "DEATH",
    Css: "tcard13",
    Chat: "\"The Death card - your fate lies out of your own hands when Death commands your fortunes. You cannot change the situation you find yourself in, and it is only by closing the door to the past that a new one can open. Going forward into the unknown, by letting go of that which was only true in the past, is the only way to escape from the misfortunes of the present.\"\n\n"+
...
App.Data.Tarot["014"] = {
    Name: "The Temperance",
    Css: "tcard14",
    Chat: "\"Ah... it seems your fate now lies under the measured direction of Temperance,\" says Madame Blanche. \"She signifies good health and vitality in full measure, but also a need for finding balance in one's circumstances. Through compromise and making accords with others, Temperance can help you find the middle ground that could improve your harsh position.\"\n\n"+
...
App.Data.Tarot["015"] = {
    ...
    "\"Beware, child,\" she warns, \"for The Devil holds the reigns of your fortune.\"\n\n"+
...
App.Data.Tarot["016"] = {
    ...
    Css: "tcard16",
    Chat:
    "\"The Tower. It means your fate is in question, your plans thwarted, and great peril now surrounds you. You have fallen into a place from which chaos has taken over your life, and your ego has been humbled. Regrettably, this is not a card for good news,\" says Madame Blanche.\n\n"+
...
App.Data.Tarot["017"] = {
    Name: "The Star",
    Css: "tcard17",
    Chat: "\"This card means good things lie in the future. The Star is a symbol of hope, of creativity and giving. It means inspiration may be coming to you, and that you can find a sense of peace and harmony,\" she smiles.\n\n"+
...
App.Data.Tarot["018"] = {
    Name: "The Moon",
    Css: "tcard18",
    Chat: "\"The Moon signifies a moment of confusion, anxiety and disorientation. Your life may be full of things unfamiliar and frightenting, but your own inability to think clearly and overcome your own illusions and fears prevents you from overcoming them. Fortunately, The Moon also gives you the freedom to act on your imagination, opening yourself to creativity which may help you find an escape.\"\n\n"+
...
App.Data.Tarot["019"] = {
    Name: "The Sun",
    Css: "tcard19",
    Chat: "\"The Sun guides your path, I am glad to say. The light of The Sun is a powerful and benevolent force, giving you good fortune and confidence in matters you face ahead. This is a way of courage and vitality, of self-assuredness and success.\"\n\n"+
...
App.Data.Tarot["020"] = {
    Name: "Judgement",
    Css: "tcard20",
    Chat: "\"This reading is cloudy for me,\" she says, \"because much is left for you to decide. That's how Judgement works, as it represents many things, making it one of the most difficult among the Tarot to discern.\"\n"+
...
App.Data.Tarot["021"] = {
    ...
    Effects : [ "HEAL_LEGENDARY", "ENERGY_LEGENDARY", "NUTRITION_LEGENDARY", "BOLSTER_WILL_COMMON" ]
};

App.Data.Tarot["022"] = {
    Name: "The Fool",
    Css: "tcard22",
    Chat: "\"Ah, The Fool,\" says Madame Blanche. \"His journey represents the beginning of all things, though he is accompanied by doubt and uncertainty. The Fool tells us that transition lies ahead of you, through personal transformations and life changes that will take place as you travel along. He also represents embracing folly, by taking chances where the odds are long or the choice seems crazy, in order to obtain the thing you desire most.\"\n\n"+
